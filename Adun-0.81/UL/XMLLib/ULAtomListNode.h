...
#ifndef _ULATOMLISTNODE_H_
#define _ULATOMLISTNODE_H_

#include <Foundation/Foundation.h>
#include "ULMolecularLibraryNode.h"

@interface ULAtomListNode : ULMolecularLibraryNode
{

}

/**
Returns an array of the library defined atom name for the atoms in the list
*/
- (NSArray*) atomNames;
